        ...
        >
          ...
          <Modal isOpen={!!deleteTarget} onClose={() => setDeleteTarget(null)} title="Confirmer la Suppression">
            <div className="text-center py-4">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">Supprimer ce règlement ?</h3>
              <p className="text-sm text-slate-600 mb-1">Vous êtes sur le point de supprimer définitivement le règlement :</p>
